...
public class RegularPendulum extends AbstractPendulum {
	...
	public RegularPendulum(double inLength, double inMass, double inTheta0,
		...
		lastAccel = -(this.getGravitationalField() / this.getStringLength()) *
			Math.sin(lastTheta);
	}
	...
	public void step() {
		...
		lastAccel = - dissipation * lastVel - this.getGravitationalField() /
			this.getStringLength() * Math.sin(lastTheta);
	}
